...
apppCore.queryVars=false;apppCore.log("apppCore",apppCore);if(!apppCore.is_appp_true&&!apppCore.QueryVars("appp")&&apppCore.isApp()&&apppCore.isMobile()){window.location.href=apppCore.AddQueryVar(window.location.href,"appp",1);
