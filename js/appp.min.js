...
apppCore.queryVars=false;apppCore.log("apppCore",apppCore);if(!apppCore.is_appp_true&&!apppCore.QueryVars("appp")&&apppCore.isApp()&&apppCore.isMobile()){apppCore.log("apppCore.is_appp_true",!!apppCore.is_appp_true);
apppCore.log("apppCore.QueryVars('appp')",!!apppCore.QueryVars("appp"));apppCore.log("apppCore.isApp()",!!apppCore.isApp());apppCore.log("apppCore.isMobile()",!!apppCore.isMobile());
return;window.location.href=apppCore.AddQueryVar(window.location.href,"appp",1);}};apppCore.ReadCookie=function(b){var e=b+"=";var a=document.cookie.split(";");
...
};apppCore.EraseCookie=function(a){if(apppCore.ReadCookie(a)){document.cookie=a+"=";}apppCore.log(a+" erased.");};apppCore.DeleteCookie=function(a){document.cookie=a+"=; expires=Thu, 01 Jan 1970 00:00:01 GMT;";
